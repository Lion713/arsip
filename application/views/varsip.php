		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				if (isset($file) && in_array(pathinfo($file, PATHINFO_EXTENSION), $pdfFormat)) { ?>
					<iframe id="pdf-js-viewer" src="<?= base_url('vendor/pdfjs/web/viewer.html?file=/files/').$file;?>" title="webviewer" width="100%" frameborder="0" scrolling="yes" style="display:block; width:100%; height:80vh;"></iframe>
